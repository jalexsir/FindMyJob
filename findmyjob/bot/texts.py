...
MSG_ABUSE_DETECTED = (
    "⚠️ Виявлено аномальну активність: забагато запитів за короткий "
    "проміжок часу.\n\n"
    "Автоматично активовано захисний тайм-аут — 10 секунд."
)
MSG_ABUSE_ACK_CONFIRMED = "🛡 Тайм-аут триває. Зачекайте ще 10 секунд, будь ласка."
