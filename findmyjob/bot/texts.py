...
BTN_SHOW_HIDDEN = "🔍 Приховані"
BTN_FAVORITES = "⭐ Обране"
BTN_NOTIFICATIONS = "🔔 Сповіщення"
BTN_CLEAR = "🧹 Очистити листування"
# Інлайн-підпис (build_show_hidden_prompt_keyboard) — над "🔍 Показати
# приховані вакансії", а не кнопка постійної клавіатури.
BTN_CLEAR_HIDE = "🧹 Очистити приховані"
BTN_NDA_SHOW_NEW = "🆕 Нові"
BTN_NDA_SHOW_ALL = "📋 Всі"
...
BTN_SHOW_HIDDEN_LIST = "🔍 Показати приховані вакансії"
...
BTN_COFFEE = "☕ На каву"
BTN_ARCHITECTURE = "🏗 Архітектура бота"
...
MSG_INTRO = (
    ...
    "дублікатів.\n\n"
    "<b>Як це працює:</b>\n"
    "1️⃣ Оберіть свої категорії — 55 напрямків плюс окрема NDA-All, до 6 "
    "одночасно\n"
    ...
    "🫥 Приховані з пошуку — приховуй нецікаве\n"
...
# Відповідь на будь-яке повідомлення, що не збіглося з жодною кнопкою чи
# командою (MenuHandlers, filters.ALL) — навмисний "глухий кут" для
# ручного вводу: бот приймає лише кнопки меню.
MSG_USE_MENU_BUTTONS = "Скористайтесь кнопками меню"
...
MSG_CLEAR_CONFIRM = (
    "⚠️ Всі повідомлення в цьому чаті будуть очищені, але списки прихованих і "
    "обраних вакансій залишаться незмінними.\n\nЦе може зайняти до 2 хвилин в залежності від кількості повідомлень.\n\nПродовжити?"
)
MSG_NOTIFY_INTRO = (
...
MSG_HIDDEN_EMPTY = "📭 Список прихованих вакансій порожній."
...
MSG_ABUSE_DETECTED = (
    "⚠️ Виявлено аномальну активність — забагато запитів за короткий час. "
    "Автоматично активовано захисний тайм-аут на 10 секунд."
)
# Той самий зміст, що й MSG_ABUSE_DETECTED, але з HTML-форматуванням — для
# кнопок нижнього меню (reply keyboard), де показати нативний Telegram alert
# технічно неможливо (show_alert працює лише для inline callback_query), тож
# повідомлення виділяється жирним, щоб не загубитись серед звичайних.
MSG_ABUSE_DETECTED_HTML = (
    "⚠️ <b>Виявлено аномальну активність</b>\n\n"
    "Забагато запитів за короткий час.\n"
    "Автоматично активовано захисний тайм-аут — <b>10 секунд</b>."
)
# Email — звичайним текстом, не URL-кнопкою: Telegram Bot API відхиляє
# mailto: в InlineKeyboardButton.url (Button_url_invalid), сам текст
...
MSG_INFO = (
    ...
    "🏗 Нижче посилання де ти можеш ознайомитися з архітектурою боту"
)
